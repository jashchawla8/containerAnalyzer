# ai_agent_splitter_recursive_retriever_bm25.py
# Uses RecursiveCharacterTextSplitter and BM25Retriever
import os
import time
...
# BM25Retriever instead of Chroma
vectorstore = Chroma.from_documents(doc_chunks, HuggingFaceEmbeddings(model_name="all-MiniLM-L6-v2"))
retriever = BM25Retriever.from_documents(doc_chunks)
